...
- 完善 256k、1024k、4096k、16384k 物品/流体无限制存储元件，补充对应配方、模型和贴图。
- 修复混合终端右侧 View Cell UI、合成状态返回混合终端，以及数量选择界面“下一页”无响应问题。
...
- 提供 1k / 4k / 16k / 64k / 256k / 1024k / 4096k / 16384k 物品盘与流体盘，以及共用「无限制外壳」合成组件。
...
```text
build/libs/NH-AddTings-Juzi-0.1.9b.jar
```
